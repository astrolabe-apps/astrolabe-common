...
const RNRadioGroup = React.forwardRef<
...
RNRadioGroup.displayName = RadioGroupPrimitive.Root.displayName;

const RNRadioGroupItem = React.forwardRef<
...
RNRadioGroupItem.displayName = RadioGroupPrimitive.Item.displayName;

export { RNRadioGroup, RNRadioGroupItem };
