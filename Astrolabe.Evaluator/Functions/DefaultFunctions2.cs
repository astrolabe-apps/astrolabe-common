...
/// <summary>
/// FunctionHandler2 versions of the default functions that work with the new EvalEnv API.
/// </summary>
public static class DefaultFunctions2
{
    ...
    /// </summary>
    public static FunctionHandler2 BinNullPropFunction(
        string name,
        Func<object, object, EvalEnv, object?> evaluate)
    {
    ...
    /// </summary>
    public static FunctionHandler2 UnaryNullOp(string name, Func<object, object?> evaluate)
    {
        return (env, call) =>
        {
    ...
    /// </summary>
    private static FunctionHandler2 ShortCircuitBoolOp(
        string name,
    ...
    /// </summary>
    private static readonly FunctionHandler2 IfElseOp = (env, call) =>
    {
    ...
    /// </summary>
    private static readonly FunctionHandler2 NullCoalesceOp = (env, call) =>
    {
        if (call.Args.Count != 2)
        {
    ...
    /// </summary>
    private static FunctionHandler2 ArrayOp(string name, Func<List<ValueExpr>, ValueExpr?, EvalEnv, EvalExpr> arrayFunc)
    {
        return (env, call) =>
        {
    ...
    /// </summary>
    private static readonly FunctionHandler2 SumOp = (env, call) =>
    {
        if (call.Args.Count == 0)
    ...
    /// Count function.
    /// </summary>
    private static readonly FunctionHandler2 CountOp = (env, call) =>
    {
        if (call.Args.Count == 0)
    ...
    /// </summary>
    private static readonly FunctionHandler2 ElemOp = (env, call) =>
    {
        if (call.Args.Count != 2)
        {
    ...
    /// </summary>
    private static readonly FunctionHandler2 MapOp = (env, call) =>
    {
        if (call.Args.Count != 2)
        {
    ...
    /// </summary>
    private static readonly FunctionHandler2 FilterOp = (env, call) =>
    {
        if (call.Args.Count != 2)
        {
    ...
    /// </summary>
    private static readonly FunctionHandler2 FlatMapOp = (env, call) =>
    {
        if (call.Args.Count != 2)
        {
    ...
    /// </summary>
    private static FunctionHandler2 StringOp(string name, Func<string, string> transform)
    {
        return (env, call) =>
        {
            var partials = call.Args.Select(a => env.EvaluateExpr(a)).ToList();
    ...
    /// </summary>
    private static readonly FunctionHandler2 ThisOp = (env, call) =>
    {
    ...
    /// </summary>
    private static FunctionHandler2 AggFunction(
        string name,
        double? init,
    ...
    /// </summary>
    private static FunctionHandler2 FirstFunction(
        string name,
    ...
    /// </summary>
    private static readonly FunctionHandler2 ContainsOp = (env, call) =>
    {
        if (call.Args.Count != 2)
    ...
    /// </summary>
    private static readonly FunctionHandler2 IndexOfOp = (env, call) =>
    {
        if (call.Args.Count != 2)
    ...
    /// </summary>
    private static readonly FunctionHandler2 KeysOp = (env, call) =>
    {
        if (call.Args.Count != 1)
    ...
    /// </summary>
    private static readonly FunctionHandler2 ValuesOp = (env, call) =>
    {
        if (call.Args.Count != 1)
    ...
    /// </summary>
    private static readonly FunctionHandler2 MergeOp = (env, call) =>
    {
        if (call.Args.Count == 0)
    ...
    /// </summary>
    private static readonly FunctionHandler2 ObjectOp = (env, call) =>
    {
    ...
    /// </summary>
    private static readonly FunctionHandler2 WhichOp = (env, call) =>
    {
    ...
    /// </summary>
    private static readonly FunctionHandler2 FixedOp = (env, call) =>
    {
        if (call.Args.Count != 2)
    ...
    /// </summary>
    public static readonly IReadOnlyDictionary<string, FunctionHandler2> FunctionHandlers2 =
        new Dictionary<string, FunctionHandler2>
        {
            // Arithmetic
    ...
    /// <summary>
    /// Convert FunctionHandler2 dictionary to ValueExpr dictionary for use with EvalEnv.
    /// </summary>
    public static IReadOnlyDictionary<string, EvalExpr> AsValueExprs(
        this IReadOnlyDictionary<string, FunctionHandler2> handlers)
    {
