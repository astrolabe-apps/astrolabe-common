...
export const buttonVariants = cva(
	"btn inline-flex items-center justify-center rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed ring-offset-surface-500",
	{
		variants: {
			variant: {
				default:
					"bg-primary-500 text-white hover:bg-primary-600 disabled:bg-primary-300/50 disabled:text-surface-800",
				primary:
					"bg-primary-500 text-white hover:bg-primary-600 disabled:bg-primary-300/50 disabled:text-surface-800",
				...
				danger:
					"bg-danger-500 text-danger-50 hover:bg-danger-600 disabled:bg-danger-300/50 disabled:text-surface-800",
				outline: "border border-current",
				soft: "text-primary-700 hover:bg-primary-200 bg-primary-100",
				ghost:
					"text-primary-700 hover:bg-primary-200 bg-primary-100 border border-primary-300",
				gray: "text-secondary-500 hover:bg-primary-100 bg-surface-100 disabled:bg-surface-50 disabled:cursor-not-allowed disabled:border disabled:border-surface-100 disabled:text-gray-600",
			...
			size: {
				default: "min-h-[44px] py-2 px-4 text-sm font-medium",
