...
public class ArrayObjectControlTests
{
    ...
    public void Control_Should_Detect_Array_Type()
    {
        ...
        var control = Control.Create(list, list);
    ...
    {
        var control = Control.Create("hello", "hello");
    ...
    {
        var control = Control.Create(42, 42);
    ...
    {
        var dict = new Dictionary<string, object> { ["Name"] = "John", ["Age"] = 30 };
        var control = Control.Create(dict, dict);
    ...
    {
        var dict = new Dictionary<string, object> { ["Name"] = "John" };
        var parent = Control.Create(dict, dict);
    ...
    public void Array_Child_Control_Should_Update_Parent_Array()
    {
        ...
        var parent = Control.Create(list, list);
        var editor = new ControlEditor();
    ...
    public void Child_Controls_Should_Be_Preserved_When_Parent_Value_Changes()
    {
        ...
        var control = Control.Create(dict1, dict1);
        var editor = new ControlEditor();
    ...
    public void Nested_Objects_Should_Work()
    {
        ...
        var control = Control.Create(nested, nested);
    ...
    public void Nested_Arrays_Should_Work()
    {
        ...
        var control = Control.Create(nestedArrays, nestedArrays);
    ...
    {
        var dict = new Dictionary<string, object> { ["Name"] = "John" };
        var control = Control.Create(dict, dict, ControlFlags.Disabled);
        var editor = new ControlEditor();
    ...
    {
        var dict = new Dictionary<string, object> { ["Name"] = "John" };
        var control = Control.Create(dict, dict, ControlFlags.Touched);
