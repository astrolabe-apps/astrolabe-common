...
Next.js frontend application for __ProjectName__.
...
rush build --to @__ProjectName__/__SiteName__
```
...
This application connects to the __ProjectName__ backend API. The API client is automatically generated from the OpenAPI specification using NSwag.
